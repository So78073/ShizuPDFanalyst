...
class MainWindow(QWidget):
    def __init__(self):
        ...
        self.setWindowTitle("PDF offset Analist")
        self.setGeometry(100, 100, 600, 400)
        self.setWindowIcon(QIcon("data/assets/icon.ico"))
        self.setStyleSheet("""
        ...
        self.default_output_dir = os.path.join(os.path.expanduser('~'), 'Desktop', 'PDFanalyse Output')
    ...
    def on_send_clicked(self):
        ...
        self.show_progress_message(f"<span style='color: {colorText['obs']};'>Iniciando análise...\nO Software não travou, estamos apenas analizando seu arquivo ^^ se estiver demorando muito é por que o arquivo é bem grande .</span><br>")
...
Paginas Geradas pelo app: Verifique se os arquivos foram gerados corretamente na pasta de saída escolhida.<br><br>
